...
impl DaemonState {
    ...
    async fn start_thread(&self, workspace_id: String) -> Result<Value, String> {
        shared::provider_runtime_core::start_thread_via_provider_core(
            &self.sessions,
            &self.workspaces,
            &self.app_settings,
            workspace_id,
    ...
    async fn resume_thread(
        ...
        shared::provider_runtime_core::resume_thread_via_provider_core(
            &self.sessions,
            &self.workspaces,
            &self.app_settings,
            workspace_id,
    ...
    async fn archive_thread(
        ...
        shared::provider_runtime_core::archive_thread_via_provider_core(
            &self.sessions,
            &self.workspaces,
            &self.app_settings,
            workspace_id,
    ...
    async fn model_list(&self, workspace_id: String) -> Result<Value, String> {
        shared::provider_runtime_core::model_list_via_provider_core(
            &self.sessions,
            &self.workspaces,
            &self.app_settings,
            workspace_id,

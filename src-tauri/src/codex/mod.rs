...
pub(crate) async fn fork_thread(
    ...
    crate::shared::provider_runtime_core::fork_thread_via_provider_core(
        &state.sessions,
        &state.workspaces,
        &state.app_settings,
        workspace_id,
...
pub(crate) async fn archive_thread(
    ...
    crate::shared::provider_runtime_core::archive_thread_via_provider_core(
        &state.sessions,
        &state.workspaces,
        &state.app_settings,
        workspace_id,
...
pub(crate) async fn start_review(
    ...
    crate::shared::provider_runtime_core::start_review_via_provider_core(
        &state.sessions,
        &state.workspaces,
        &state.app_settings,
        workspace_id,

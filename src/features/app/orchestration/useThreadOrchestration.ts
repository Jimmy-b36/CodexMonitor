...
type UseThreadCodexSyncOrchestrationParams = {
  ...
  setPreferredMethodId: SetState<string | null>;
...
export function useThreadCodexSyncOrchestration({
  ...
  useLayoutEffect(() => {
    ...
    setPreferredMethodId(resolved.preferredMethodId);
...
export function useThreadSelectionHandlersOrchestration({
  ...
  const handleSelectMethod = useCallback(
    (id: string | null) => {
      ...
      persistThreadCodexParams({ methodId: id });
    },
    [persistThreadCodexParams, setSelectedMethodId],
  );
